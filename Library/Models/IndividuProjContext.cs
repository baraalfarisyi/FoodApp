...
{
    public partial class IndividuProjContext : DbContext
    {
        public IndividuProjContext()
        {
        }

        public IndividuProjContext(DbContextOptions<IndividuProjContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=DESKTOP-97LTBR2\\SQLEXPRESS;Database=IndividuProj;uid=tester;pwd=123;");
//            }
        }
